...
pub enum Type {
    ...
    Reference(Box<Type>),
    /// An owned runtime wrapper containing an object pointer and an interface
    /// vtable pointer.
...
pub fn mangle_type_name(type_: &Type) -> String {
    ...
    match type_ {
        ...
        Type::Primitive(PrimitiveType::Byte) => "Y".to_string(),
        Type::Primitive(PrimitiveType::Bytes) => "Z".to_string(),
        ...
        Type::TraitObject(inner) => frame("V", [mangle_type_name(inner)]),
